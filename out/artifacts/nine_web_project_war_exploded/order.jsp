...
<script type="text/javascript">
	function commitOrder(uid,sum) {

		location.href="order?method=commitOrder&uid="+uid+"&sum="+sum+"&aid="+$("#address").val();
	}
</script>
</head>
...
<div class="container" style="background-color: white;">
	...
	<div class="row pull-right" style="margin-right: 40px;">
		 <div style="margin-bottom: 20px;">
	            <button  id="btn_add" class="btn  btn-danger btn-lg" type="button" onclick="commitOrder(${loginUser.uid},${sum})">提交订单</button>
	     </div>
	</div>
</div>
